...
export default {
    ...
    registerCommands() {
        ...
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:unfoldAtLevel1': () => this.unfoldAtLevel1()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:unfoldAtLevel2': () => this.unfoldAtLevel2()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:unfoldAtLevel3': () => this.unfoldAtLevel3()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:unfoldAtLevel4': () => this.unfoldAtLevel4()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:unfoldAtLevel5': () => this.unfoldAtLevel5()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:foldAtLevel1': () => this.foldAtLevel1()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:foldAtLevel2': () => this.foldAtLevel2()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:foldAtLevel3': () => this.foldAtLevel3()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:foldAtLevel4': () => this.foldAtLevel4()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:foldAtLevel5': () => this.foldAtLevel5()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:maxFoldLevel1': () => this.maxFoldLevel1()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:maxFoldLevel2': () => this.maxFoldLevel2()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:maxFoldLevel3': () => this.maxFoldLevel3()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:maxFoldLevel4': () => this.maxFoldLevel4()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:foldAtLevel5': () => this.foldAtLevel5()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:toggleFoldsLevel1': () => this.toggleFoldsLevel1()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:toggleFoldsLevel2': () => this.toggleFoldsLevel2()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:toggleFoldsLevel3': () => this.toggleFoldsLevel3()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:toggleFoldsLevel4': () => this.toggleFoldsLevel4()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'pattern-navigator:toggleFoldsLevel5': () => this.toggleFoldsLevel5()
        }));
        this.subscriptions.add(atom.commands.add('atom-workspace', {
    ...
    parse(editor) {
        ...
        for (var i = 0; numberOfRows > i; i++) {
            ...
            if (matching) {
                ...
                let lineNumberSpan = "";
                //let lineContent = "";
                let classList = "navigator-item";
                let id = "";
                let gutter = '<span class="navigator-gutter"></span>';
                let content = '';
    ...
    maxFoldLevel(level) {
        ...
        atom.config.set("navigator.maxFoldLevel", level);
        this.parse(editor);
    },
